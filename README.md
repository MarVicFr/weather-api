...
Once you have the correct node version, run `yarn` to get all the required dependencies installed

After everything is installed, run `yarn dev` and navigate to http://localhost:3000
