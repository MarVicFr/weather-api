  ...
  return (
    <main className="flex justify-center items-center bg-gradient-to-br from-sky-400 via-rose-400 to-lime-400 h-[100vh] w-full">
      <section
        ...
        lg:h-[500px] bg-white bg-opacity-20 backdrop-blur-lg drop-shadow-lg rounded text-zinc-700 "
      >
        <h1 className="text-4xl font-thin">
          Votre <span className="font-black">metéo</span>
        </h1>
        <p className="text-sm mt-2">
          Entrer ci-dessous le nom de la ville dont vous souhaitez connaître la
          metéo et autres informations climatiques.{' '}
        </p>
        <div className="flex relative mt-10 md:mt-4">
          ...
          <button className="rounded-r-md border-2 border-zinc-100 hover:border-zinc-500 hover:text-zinc-100 px-2 py-1 cursor-pointer" onClick={onSubmit}>
            GO
          </button>
        </div>
      </section>
